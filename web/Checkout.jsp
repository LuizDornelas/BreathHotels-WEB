            ...
            <center>
                <form action="CheckoutDados" method="GET">   
                    <div class="col" style="width: 50%;">
                        <h2 style="margin-bottom: 40px; margin-top: 140px; color: #0277bd; text-align: center; font-size: 42px; ">Check-Out</h2>

                        <div class="input-field">
                            <select name="reserva" class="browser-default" style="width: 70%;">
                        ...
                        <div class="bot">                                    
                            ...
                            <input class="btn btn-primary" style="width: 70%; background: #0277bd;" type="submit" name="acao" value="Pagamento Cartao"><br><br>
                            <input class="btn btn-primary" style="width: 70%; background: #0277bd;" type="submit" name="acao" value="Pagamento Dinheiro"><br><br>

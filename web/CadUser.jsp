                ...
                <form action="CadastroUsuario" method="POST">   
                    <div class="col" style="width: 40%;">
                        ...
                        <div class="input-field" style="width: 70%;">
                            <input type="text"  id="nome" name="txt_nome" maxlength="80" required">
                            <label class="active">Nome</label>
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="text" name="txt_rg" maxlength="13" OnKeyPress="formatar('##.###.###-##', this)" class="form-control" required>
                            <label class="active">Documento de identidade</label>
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="text" name="txt_telefone" onkeydown="phoneMask()" maxlength="15" class="form-control" required>
                            <label class="active">Telefone</label>
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="text" name="txt_rua" maxlength="40" class="form-control" required>
                            <label class="active">Rua</label>
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="number" min="0" id="number" max="9999" name="txt_numero" class="form-control" required>
                            <label class="active">Número</label>
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="text" name="txt_bairro" maxlength="40" class="form-control" required ">
                            <label class="active">Bairro</label>
                        </div>

                        <div  class="input-field" style="width: 70%;">
                            <input type="text" name="txt_cidade" maxlength="40" class="form-control" required >
                            <label class="active">Cidade</label>
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="text" name="txt_estado" maxlength="40" class="form-control" required >
                            <label class="active">Estado</label>
                        </div>

                        <div  class="input-field" style="width: 70%;">
                            <input type="text" name="txt_cep" maxlength="9" OnKeyPress="formatar('#####-###', this)" class="form-control" required>
                            <label class="active">CEP</label>
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="text" name="txt_login" maxlength="20" class="form-control" required>
                        ...
                        <div class="input-field">
                            ...
                            %>
                            <select name="cmb_tipo" class="browser-default" style="width: 70%;">

        ...
        <!-- Reservas -->
         <div class="listando">
            <center> 
                ...
                <h3 style="margin-bottom: 40px; margin-top: 55px; color: #0277bd; text-align: center; font-size: 42px; ">Reservas Encerradas</h3>
            ...
            <%}%>
                <br><br>
            <a class="btn btn-outline-secondary" href="indexCliente" style="background: #0277bd">Voltar</a>        
            <br><br>
            </center>
        </div>
        <!-- rodapé -->

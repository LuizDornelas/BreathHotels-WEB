...
<html>
    ...
    <body id="conteudo">
        ...
        <div class="row" style="width: 96%; background-color: #fff;
            ...
            <center>
                <form action="ConfirmarEdicaoItem" method="POST">   
                    <div class="col" style="width: 42%;">
                        <h2 style="margin-bottom: 40px; margin-top: 100px; color: #0277bd; text-align: center; font-size: 42px; ">Atualizar itens</h2>

                        <div class="input-field" style="width: 70%;">
                            <input type="hidden" name="txt_id" class="form-control" value="${item.id}">
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="text" name="txt_item" maxlength="25" class="form-control" required value="${item.nome_item}">
                            <label class="active">Item</label>
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="number" min="0" id="number" max="9999" step="0.01" name="txt_valor_item" class="form-control" required value="${item.valor_item}">
                            <label class="active">Valor</label>
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="number" min="0" id="number2" max="9999" step="0.01" name="txt_valor_compra" class="form-control" required value="${item.valor_compra}">
                            <label class="active">Valor fornecedor</label>
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="number" min="0" id="number3" max="999" name="txt_quantidade" class="form-control" required value="${item.quantidade}">
                            <label class="active">Quantidade</label>
                        </div>

                        <div class="input-field" style="width: 70%;">
                            <input type="text" name="txt_nome_fornecedor" maxlength="25" class="form-control" required value="${item.nome_fornecedor}">
                ...
                <div class="col"><img src="view/img/fotosHotel/food1.jpg" alt="Donuts" style="width: 48vw; margin-top: 30px; "></div>                      
            </center>
        </div> 
        <!-- rodapé -->

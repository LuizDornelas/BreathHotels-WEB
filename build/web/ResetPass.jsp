            ...
            <center>
                <form action="ResetSenha" method="POST">   
                    <div class="col" style="width: 40%;">
                        <h2 style="margin-bottom: 40px; margin-top: 70px; color: #0277bd; text-align: center; font-size: 42px; ">Resetar Senha</h2>

                        <div class="input-field" style="width: 70%;">
                            <input type="hidden" name="txt_id" maxlength="20" class="form-control" value="${usuario.id}">
                        </div>
                        ...
                        <div class="bot">                                    
                            ...
                            <%}%> 
                            <br>
                            <input class="btn btn-primary" style="width: 70%; background: #0277bd;" type="submit" name="acao" value="Resetar Senha"><br><br>
                            <a href="ListarUsuario">Voltar</a> 
                            </br>
                        </div>                    
                    </div>
                </form>
                <div class="col"><img src="view/img/fotosHotel/senha.jpg" alt="senha" style="width: 52vw; margin-top: 30px;"></div>                      
            </center>
        </div>
        <!-- rodapé -->

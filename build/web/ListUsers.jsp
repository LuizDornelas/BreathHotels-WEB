...
<html>
    ...
    <body id="conteudo"> 
        ...
        <div class="listandoUsers">     
            <center> 
                <h3 style="margin-bottom: 40px; margin-top: 55px; color: #0277bd; text-align: center; font-size: 42px; ">Usuários</h3>
            ...
            <c:forEach items="${todosUsuarios}" var="user">
                <tr>                                           
                    ...
                    <td align="center"><a style="color: #0277bd" href="IniciarEdicaoUsuario?id=${user.id}" alt="">Editar</a></td>    
                    <td align="center"><a style="color: #0277bd" href="IniciarResetSenha?id=${user.id}" alt="">Resetar Senha</a></td>  
                </tr>
            </c:forEach>
        </table>      
        <br><br>
        <a class="btn btn-outline-secondary" style="background: #0277bd" href="index">Voltar</a>  
        <a class="btn btn-outline-primary" style="background: #0277bd"  href="CadUser.jsp">Cadastrar Usuários</a>
        <br><br>
    </div>
    <footer>
        <!-- rodapé -->

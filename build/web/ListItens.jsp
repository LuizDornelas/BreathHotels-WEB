...
<html>
    ...
    <body id="conteudo">   
        ...
        <div class="listando">
            <center>   
                <h3 style="margin-bottom: 40px; margin-top: 55px; color: #0277bd; text-align: center; font-size: 42px; ">Itens</h3>
                <table class="striped highlight" border="1">
                    <div class="input-field col s12">
                    <input type="text" style="" id="search" class="form-control" placeholder="Buscar item"/><br>
                    </div>
                    <tr>                
            ...
            <c:forEach items="${todosItens}" var="item">
                <tr>            
                    ...
                    <td align="center"><a style="color: #0277bd" href="IniciarEdicaoItem?id=${item.id}" alt="">Editar</a></td>     
                    <td align="center"><a style="color: #0277bd" href="ExcluirItem?id=${item.id}" alt="">Excluir</a></td>  
                </tr>
            </c:forEach>
        </table>
        ...
        <a class="btn btn-outline-primary" style="background: #0277bd" href="CadItens.jsp">Cadastrar Itens</a>        
    </div>
  <!-- rodapé -->

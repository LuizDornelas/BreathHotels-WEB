        ...
        <div class="listando">  
            <center>       
                ...
                <table class="striped highlight" border="1">
                    <div class="input-field col s12">
                        <input type="text" style="" id="search"  placeholder="Busca quarto"/><br>  
                    </div>
                    <tr>                
            ...
            <c:forEach  items="${todosQuartos}" var="quartos">
                <tr>            
                    ...
                    <td align="center"><a style="color: #0277bd" href="IniciarEdicaoQuarto?id=${quartos.id}" alt="">Editar</a></td>     
                    <td align="center"><a style="color: #0277bd" href="ExcluirQuarto?id=${quartos.id}" alt="">Excluir</a></td>  
                </tr>
            </c:forEach>
        </table>        
        <br><br>
        <a class="btn btn-outline-secondary" style="background: #0277bd" href="index">Voltar</a>  
        <a class="btn btn-outline-primary" style="background: #0277bd" href="CadBedroom.jsp">Cadastrar Quartos</a> 
    </div>
    <!-- rodapé -->
